...
const translations = {
    en: {
        ...
        rtpmidi_autoconnect: "RTP MIDI Auto-Connect",
        auto_connect_port: "Auto-connect to Port / Session",
        rtpmidi_sessions: "RTP MIDI Network Sessions",
        discovered_rtp_sessions: "Discovered Network Sessions (mDNS)",
        manual_rtp_connection: "Manual Connection (Host & Port)",
        connected_rtp_peers: "Active Connected RTP Sessions",
        scan_peers: "Scan",
        rtp_discovered_hint: "Select any discovered peer (like OSCMidi or DAW) to connect without typing host/port.",
    ...
    fr: {
        ...
        rtpmidi_autoconnect: "Connexion automatique RTP-MIDI",
        auto_connect_port: "Port de connexion automatique",
        rtpmidi_sessions: "Sessions Réseau RTP MIDI",
        discovered_rtp_sessions: "Sessions découvertes sur le réseau (mDNS)",
        manual_rtp_connection: "Connexion manuelle (Hôte & Port)",
        connected_rtp_peers: "Sessions RTP actives connectées",
        scan_peers: "Scanner",
        rtp_discovered_hint: "Sélectionnez une session découverte (ex: OSCMidi ou DAW) pour vous connecter sans saisir l'hôte/port.",
