...
function translateStaticContent() {
    ...
    if (typeof window.initializeThemeControls === 'function') {
...
const translations = {
    en: {
        ...
        appearance_title: "Customize the colors and style of the interface.",
        appearance_intro: "Start with the mode and palette, then adjust the background, cards, icons, and dashboard badges.",
        live_preview: "Live preview",
        appearance_preview_navigation: "Navigation",
        appearance_preview_navigation_desc: "Icons and active links",
        appearance_preview_cards: "Cards",
        appearance_preview_cards_desc: "Surfaces, corners, and contrast",
        appearance_preview_badges: "Badges",
        appearance_preview_badges_desc: "CPU, RAM, and status pills",
        appearance_style_title: "Global style",
        appearance_style_help: "Mode controls overall brightness. Palette defines the main accent and default mood.",
        appearance_mode: "Mode",
        appearance_palette: "Palette",
        appearance_palette_help: "Palettes mostly adjust the accent family and suggested tones. Custom colors below stay in control.",
        appearance_accent_title: "Accent color",
        appearance_accent_help: "Used for active navigation, glow, and several interactive elements.",
        appearance_hex_value: "Hex value",
        appearance_quick_swatches: "Quick swatches",
        appearance_colors_title: "Custom colors",
        appearance_colors_help: "These colors visibly affect the background, cards, icons, and dashboard badges.",
        appearance_background_color: "Background color",
        appearance_background_color_help: "Main background color.",
        appearance_surface_color: "Card color",
        appearance_surface_color_help: "Tints panels, cards, and floating windows.",
        appearance_icon_color: "Icon color",
        appearance_icon_color_help: "Applied to navigation and interface icons.",
        appearance_badge_color: "Badge color",
        appearance_badge_color_help: "Pills such as CPU, RAM, temperature, and states.",
        appearance_badge_text_color: "Badge text color",
        appearance_badge_text_color_help: "Used for text and small icons inside badges.",
        appearance_panels_title: "Panels",
        appearance_panels_style: "Surface style",
        appearance_corners: "Corners",
        appearance_depth_title: "Depth",
        appearance_glow: "Glow",
        appearance_contrast: "Contrast",
        appearance_background_title: "Atmosphere",
        appearance_background_scene: "Background effect",
        appearance_reset: "Reset appearance",
        theme_mode_dark: "Dark",
        theme_mode_light: "Light",
        theme_mode_auto: "Auto",
        theme_preset_aurora: "Aurora",
        theme_preset_aurora_desc: "Cyan and indigo accent",
        theme_preset_ember: "Ember",
        theme_preset_ember_desc: "Copper, orange, and rose",
        theme_preset_forest: "Forest",
        theme_preset_forest_desc: "Deep natural greens",
        theme_preset_mono: "Mono",
        theme_preset_mono_desc: "Calm studio neutrals",
        theme_preset_ocean: "Ocean",
        theme_preset_ocean_desc: "Steel blue and cyan",
        theme_preset_sunrise: "Sunrise",
        theme_preset_sunrise_desc: "Amber and warm gold",
        theme_surface_glass: "Glass",
        theme_surface_solid: "Solid",
        theme_surface_flat: "Flat",
        theme_radius_soft: "Soft",
        theme_radius_rounded: "Rounded",
        theme_radius_crisp: "Crisp",
        theme_glow_subtle: "Subtle",
        theme_glow_normal: "Normal",
        theme_glow_vivid: "Vivid",
        theme_contrast_balanced: "Balanced",
        theme_contrast_strong: "Strong",
        theme_background_ambient: "Ambient",
        theme_background_mesh: "Mesh",
        theme_background_minimal: "Minimal",
        theme_background_stage: "Stage",
        //index
        loading: "Loading...",
        home: "Home",
    ...
    fr: {
        ...
        appearance_title: "Personnalise les couleurs et le style de l’interface.",
        appearance_intro: "Commence par choisir le mode et la palette, puis ajuste les couleurs du fond, des cartes, des icônes et des badges.",
        live_preview: "Aperçu live",
        appearance_preview_navigation: "Navigation",
        appearance_preview_navigation_desc: "Icônes et liens actifs",
        appearance_preview_cards: "Cartes",
        appearance_preview_cards_desc: "Surfaces, coins et contraste",
        appearance_preview_badges: "Badges",
        appearance_preview_badges_desc: "Pastilles CPU, RAM et états",
        appearance_style_title: "Style global",
        appearance_style_help: "Le mode contrôle la luminosité générale. La palette définit l’accent principal et l’ambiance de base.",
        appearance_mode: "Mode",
        appearance_palette: "Palette",
        appearance_palette_help: "Les palettes changent surtout l’accent et les couleurs suggérées. Les couleurs personnalisées ci-dessous restent prioritaires.",
        appearance_accent_title: "Couleur d’accent",
        appearance_accent_help: "Utilisée pour la navigation active, les halos et plusieurs éléments interactifs.",
        appearance_hex_value: "Valeur hex",
        appearance_quick_swatches: "Couleurs rapides",
        appearance_colors_title: "Couleurs personnalisées",
        appearance_colors_help: "Ces couleurs ont un effet direct et visible sur le fond, les cartes, les icônes et les badges du dashboard.",
        appearance_background_color: "Couleur du fond",
        appearance_background_color_help: "Couleur principale de l’arrière-plan.",
        appearance_surface_color: "Couleur des cartes",
        appearance_surface_color_help: "Teinte les panneaux, cartes et fenêtres flottantes.",
        appearance_icon_color: "Couleur des icônes",
        appearance_icon_color_help: "Appliquée à la navigation et aux icônes d’interface.",
        appearance_badge_color: "Couleur des badges",
        appearance_badge_color_help: "Pastilles comme CPU, RAM, température et états.",
        appearance_badge_text_color: "Texte des badges",
        appearance_badge_text_color_help: "Utilisé pour le texte et les petites icônes dans les badges.",
        appearance_panels_title: "Panneaux",
        appearance_panels_style: "Style des surfaces",
        appearance_corners: "Coins",
        appearance_depth_title: "Profondeur",
        appearance_glow: "Glow",
        appearance_contrast: "Contraste",
        appearance_background_title: "Atmosphère",
        appearance_background_scene: "Effet de fond",
        appearance_reset: "Réinitialiser l’apparence",
        theme_mode_dark: "Sombre",
        theme_mode_light: "Clair",
        theme_mode_auto: "Auto",
        theme_preset_aurora: "Aurora",
        theme_preset_aurora_desc: "Accent cyan et indigo",
        theme_preset_ember: "Ember",
        theme_preset_ember_desc: "Cuivre, orange et rose",
        theme_preset_forest: "Forest",
        theme_preset_forest_desc: "Verts profonds et naturels",
        theme_preset_mono: "Mono",
        theme_preset_mono_desc: "Neutres sobres et studio",
        theme_preset_ocean: "Ocean",
        theme_preset_ocean_desc: "Bleus acier et cyan",
        theme_preset_sunrise: "Sunrise",
        theme_preset_sunrise_desc: "Ambre et chaleur dorée",
        theme_surface_glass: "Verre",
        theme_surface_solid: "Solide",
        theme_surface_flat: "Plat",
        theme_radius_soft: "Doux",
        theme_radius_rounded: "Arrondi",
        theme_radius_crisp: "Net",
        theme_glow_subtle: "Subtil",
        theme_glow_normal: "Normal",
        theme_glow_vivid: "Vif",
        theme_contrast_balanced: "Équilibré",
        theme_contrast_strong: "Fort",
        theme_background_ambient: "Ambiant",
        theme_background_mesh: "Maillage",
        theme_background_minimal: "Minimal",
        theme_background_stage: "Scène",
        //index
        loading: "Chargement...",
        home: "Accueil",
